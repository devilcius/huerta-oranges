    ...
    <div className="space-y-4">
      <div className="flex flex-col sm:flex-row sm:items-end gap-3">
        <div className="flex-1">
          <label className="block text-sm font-medium text-slate-700">Filter by buyer name</label>
          <input
            value={nameFilter}
        ...
        <div className="flex items-center gap-3 text-sm text-slate-600">
          ...
          <span>
            {visibleBuyers.length} shown / {buyers.length} total
          </span>
        </div>
      </div>
      ...
      {buyers.length === 0 ? (
        <div className="rounded-2xl border border-slate-200 bg-slate-50 p-6">
          ...
          <div className="mt-1 text-sm text-slate-600">
            Create your first buyer to start tracking bags, picking, and payment.
          </div>
          <div className="mt-4">
            <Link
              to="/buyers/new"
        ...
        <div className="rounded-2xl border border-slate-200 bg-slate-50 p-6">
          <div className="text-slate-900 font-medium">No matches</div>
          <div className="mt-1 text-sm text-slate-600">
            Try clearing the chips or adjusting the name filter.
          </div>
            ...
            return (
              ...
              >
                <div className="min-w-0">
                  <div className="font-medium text-slate-900 truncate">{buyer.buyerName || "(no name)"}</div>
                  <div className="text-xs text-slate-500 truncate">Click to open</div>
                </div>
